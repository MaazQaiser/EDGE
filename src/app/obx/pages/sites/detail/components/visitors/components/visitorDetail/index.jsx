...
import { ReactComponent as BanIcon } from 'assets/svg/ban-icon.svg?react';
    ...
    <Box className={classes.StatsWrapper}>
      <Box className={classes.statsList}>
        ...
        <Typography variant="button" className={classes.labelData}>
          {data?.lastVisit
            ? formatDayjsDateTime({ value: data?.lastVisit, formatType: dayjsFormatsEnum.date })
            : NA}
        </Typography>
      </Box>
      <Box className={classes.statsList}>
        ...
        <Typography variant="button" className={classes.labelData}>
          {data?.lastCheckin
            ? formatDayjsDateTime({ value: data?.lastCheckin, formatType: dayjsFormatsEnum.time })
            : NA}
        </Typography>
      </Box>
      <Box className={classes.statsList}>
        ...
        <Typography variant="button" className={classes.labelData}>
          {data?.lastCheckout
            ? formatDayjsDateTime({ value: data?.lastCheckout, formatType: dayjsFormatsEnum.time })
            : NA}
        </Typography>
      </Box>
      <Box className={classes.statsList}>
